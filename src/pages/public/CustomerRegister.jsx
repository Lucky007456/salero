...
export default function CustomerRegister() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Wait for AuthContext to update and redirect naturally via App.jsx
      // Or we can force navigation
      navigate('/account');
    } catch (err) {
    ...
    <div className="max-w-md mx-auto px-4 py-20 slide-up">
      <div className="bg-[#030f05] p-8 rounded-3xl border border-green-900/30">
        <div className="text-center mb-8">
          <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-emerald-500/30 mx-auto mb-4 shadow-[0_0_20px_rgba(34,197,94,0.25)]">
            <img src="/logo.png" alt="Alphovins" className="w-full h-full object-cover" />
          </div>
          <h1 className="text-2xl font-bold text-white mb-2">Create Account</h1>
          <p className="text-gray-400 text-sm">Join Alphovins for faster checkout</p>
        </div>
